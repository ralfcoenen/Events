...
class Teilnehmer(models.Model):
    ...
    bustrasse = models.CharField(_('Straße und Hausnummer'), max_length=60, blank=True, default='')
    buplz = models.CharField(_('Postleitzahl'), max_length=8, blank=True, default='')
    buort = models.CharField(_('Ort'), max_length=40, blank=True, default='')
